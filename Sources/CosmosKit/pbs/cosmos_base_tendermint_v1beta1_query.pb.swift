...
public struct Cosmos_Base_Tendermint_V1beta1_GetNodeInfoResponse {
  ...
  public var nodeInfo: Tendermint_P2p_NodeInfo {
  ...
  public var hasNodeInfo: Bool {return _storage._nodeInfo != nil}
  /// Clears the value of `nodeInfo`. Subsequent reads from it will return its default value.
  public mutating func clearNodeInfo() {_uniqueStorage()._nodeInfo = nil}
