...
public struct Terra_Oracle_V1beta1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var votePeriod: UInt64 = 0

  public var voteThreshold: String = String()

  public var rewardBand: String = String()

  public var rewardDistributionWindow: UInt64 = 0

  public var whitelist: [Terra_Oracle_V1beta1_Denom] = []

  public var slashFraction: String = String()

  public var slashWindow: UInt64 = 0

  public var minValidPerWindow: String = String()
...
public struct Terra_Oracle_V1beta1_Denom {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Terra_Oracle_V1beta1_AggregateExchangeRatePrevote {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var submitBlock: UInt64 = 0
...
public struct Terra_Oracle_V1beta1_AggregateExchangeRateVote {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var exchangeRateTuples: [Terra_Oracle_V1beta1_ExchangeRateTuple] = []
...
public struct Terra_Oracle_V1beta1_ExchangeRateTuple {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Terra_Oracle_V1beta1_Params: @unchecked Sendable {}
extension Terra_Oracle_V1beta1_Denom: @unchecked Sendable {}
extension Terra_Oracle_V1beta1_AggregateExchangeRatePrevote: @unchecked Sendable {}
extension Terra_Oracle_V1beta1_AggregateExchangeRateVote: @unchecked Sendable {}
extension Terra_Oracle_V1beta1_ExchangeRateTuple: @unchecked Sendable {}
...
extension Terra_Oracle_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Terra_Oracle_V1beta1_Params, rhs: Terra_Oracle_V1beta1_Params) -> Bool {
...
extension Terra_Oracle_V1beta1_Denom: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Terra_Oracle_V1beta1_Denom, rhs: Terra_Oracle_V1beta1_Denom) -> Bool {
...
extension Terra_Oracle_V1beta1_AggregateExchangeRatePrevote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AggregateExchangeRatePrevote"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "hash"),
    2: .same(proto: "voter"),
  ...
  public static func ==(lhs: Terra_Oracle_V1beta1_AggregateExchangeRatePrevote, rhs: Terra_Oracle_V1beta1_AggregateExchangeRatePrevote) -> Bool {
...
extension Terra_Oracle_V1beta1_AggregateExchangeRateVote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AggregateExchangeRateVote"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Terra_Oracle_V1beta1_AggregateExchangeRateVote, rhs: Terra_Oracle_V1beta1_AggregateExchangeRateVote) -> Bool {
...
extension Terra_Oracle_V1beta1_ExchangeRateTuple: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ExchangeRateTuple"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "denom"),
  ...
  public static func ==(lhs: Terra_Oracle_V1beta1_ExchangeRateTuple, rhs: Terra_Oracle_V1beta1_ExchangeRateTuple) -> Bool {
