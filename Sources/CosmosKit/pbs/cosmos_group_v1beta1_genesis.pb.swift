...
struct Cosmos_Group_V1beta1_GenesisState {
  ...
  var groupMembers: [Cosmos_Group_V1beta1_GroupMember] = []
...
extension Cosmos_Group_V1beta1_GenesisState: @unchecked Sendable {}
...
extension Cosmos_Group_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmos_Group_V1beta1_GenesisState, rhs: Cosmos_Group_V1beta1_GenesisState) -> Bool {
